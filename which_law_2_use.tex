...
to remember that the functional relation of the transit parameters and the biases/variances is smooth and slow. Therefore, one can first fit with one favourites' law, obtain a set of 
transit parameters, and use those as inputs in order to calculate the MSE of different limb-darkening laws in order to then retrieve the final transit parameters from the law that gives 
